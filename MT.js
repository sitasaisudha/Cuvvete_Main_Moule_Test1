...
// sessionStorage.setItem("comp_score",0)
  ...
  if (won == "u") {
    ...
    if (num == 0) {
      ...
      <div class="bigdiv">
        ...
        style="font-size: 78px; color: black"
      ></i>
        </div>
      </div>
      <h1 id="h"> You won</h1>
    ...
    <a href="cong.html"><button id="nxt">Next </button></a>
      ...
      <div class="bigdiv">
        <h1>Your choice</h1>
        <div id="smalldiv" class="u">
        <i align = "center" class="fas fa-hand-paper" style="font-size: 78px; color: black"></i>
        </div>
      </div>
      <h1 id="h"> You won</h1>
      <div class="bigdiv">
    ...
    <a href="cong.html"><button id="nxt">Next </button></a>
      ...
      <div class="bigdiv">
        <h1>Computers choice</h1>
        <div id="smalldiv" class="c">
          <i align = "center" class="fas fa-hand-paper" style="font-size: 48px; color: black"></i>
        </div>
      </div>
    </div>
    <button id = "replay" onclick = "reply()"> Play again </button>
